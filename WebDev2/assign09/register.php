...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
	...
	if ($fn && $ln && $e && $p) { // If everything's OK...
		...
		$q = "SELECT user_id FROM u_users WHERE email='$e'";
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			$q = "INSERT INTO u_users (email, pass, first_name, last_name, active, registration_date) VALUES ('$e', SHA1('$p'), '$fn', '$ln', '$a', NOW() )";
			$r = mysqli_query ($dbc, $q) or trigger_error("Query: $q\n<br />MySQL Error: " . mysqli_error($dbc));
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
				...
				mail($trimmed['email'], 'Registration Confirmation', $body, 'From: jmd06260@vtc.vsc.edu');
